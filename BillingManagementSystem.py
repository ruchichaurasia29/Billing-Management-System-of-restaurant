...
def reset():
    ...
    odd1_entry.delete(0, END)
    odd2_entry.delete(0, END)
    odd3_entry.delete(0, END)
    odd4_entry.delete(0, END)
    even1_entry.delete(0, END)
    even2_entry.delete(0, END)
    even3_entry.delete(0, END)
    even4_entry.delete(0, END)
    text.delete(1.0,END)
